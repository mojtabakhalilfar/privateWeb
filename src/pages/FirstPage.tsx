    ...
    return (
        <Container id='home' >
            <div className="flex flex-col sm:flex-row-reverse justify-end sm:justify-start h-[696px] bg-black w-full mt-14 sm:mt-18">
                <div className='flex sm:flex-col justify-between sm:justify-center bg-red-400 w-1/2'>
