...
const FirstPage = () => {
    ...
    return (
        <Container id='home' >
            <div className="flex flex-col sm:flex-row justify-end sm:justify-start h-[696px] bg-black w-full mt-14 sm:mt-18">
            ...
            {/* ////// */}
            <div className='flex flex-col items-center sm:items-start text-center text-white bg-black py-10 sm:pl-[10%]'>
